...
const SceneFirst: React.FC<{ message: string }> = ({ message }) => {
  ...
  const text: React.CSSProperties = {
    ...
    fontSize: 50,
    color: '#FEDE02',
    textShadow: '5px 0 #2E5094, -5px 0 #2E5094, 0 5px #2E5094, 0 -5px #2E5094, 5px 5px #2E5094, -5px -5px #2E5094, 5px -5px #2E5094, -5px 5px #2E5094',
    // backgroundColor: 'red',
    textAlign: 'center',
  };
